...
function(t) {
	...
	var i = function(i) {
			...
			return __extends(r, i), r.prototype.createNativeDisplayObject = function() {
				...
				var r = this;
				if (i != r.$skewYdeg) if (r.$skewYdeg = i, i = e(i), i = (i + r.$rotation) / 180 * Math.PI, r.$skewY = i, r.$matrixDirty = !0, r.$updateUseTransform(), t.nativeRender) r.$nativeDisplayObject.setSkewY(r.$skewYdeg);
				else {
					var n = r.$parent;
					n && !n.$cacheDirty && (n.$cacheDirty = !0, n.$cacheDirtyUp());
					var a = r.$maskedObject;
...
function(t) {
	var e = function(e) {
			...
			return __extends(i, e), Object.defineProperty(i.prototype, "numChildren", {
				...
				for (var e, i = this.$children, r = i.length, n = 0; r > n; n++) if (e = i[n], e.name == t) return e;
				return null
				...
				if (n != i) if (this.$childRemoved(e, n), this.$children.splice(n, 1), this.$children.splice(i, 0, e), this.$childAdded(e, i), t.nativeRender) this.$nativeDisplayObject.removeChild(e.$nativeDisplayObject.id), this.$nativeDisplayObject.addChildAt(e.$nativeDisplayObject.id, i);
		...
		var i = function(e) {
				...
				return __extends(i, e), i.prototype.drawImage = function(t, e, i, r, n, a, o, s) {
					...
					if (r) {
						...
						} else for (var _ = o * v, D = s * v, O = 0; p > O; O += l) for (var w = 0; d > w; w += u) {
...
function(t) {
	...
	var i = function() {
			function e() {}
			return e.language = "zh-CN", e.os = "Unknown", e.runtimeType = t.RuntimeType.WEB, e.engineVersion = "5.2.18", e.renderMode = "Unknown", e.boundingClientWidth = 0, e.boundingClientHeight = 0, e
		}();
