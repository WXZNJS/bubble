    ...
    !function(t) {
        var r = function(t) {
            ...
            r.prototype.open = function(e, t) {
                ...
                this._xhr = null);
                var r = this.getXHR();
                window.XMLHttpRequest ? (r.addEventListener("load", this.onload.bind(this)),
                r.addEventListener("error", this.onerror.bind(this))) : r.onreadystatechange = this.onReadyStateChange.bind(this),
    ...
    !function(t) {
        var r = function(t) {
            ...
            r.prototype._onInput = function() {
                var t = this;
                window.setTimeout(function() {
                    t.inputElement && t.inputElement.selectionStart == t.inputElement.selectionEnd && (t.textValue = t.inputElement.value,
    ...
    !function(t) {
        ...
        var a = function(r) {
            ...
            i.$init = function() {
                ...
                c == n.WEB_AUDIO && a || c == n.HTML5_AUDIO ? (s = !1,
                i.setAudioType(c)) : (s = !0,
                i.setAudioType(n.HTML5_AUDIO)),
                r.indexOf("android") >= 0 ? s && a && i.setAudioType(n.WEB_AUDIO) : (r.indexOf("iphone") >= 0 || r.indexOf("ipad") >= 0 || r.indexOf("ipod") >= 0) && i.getIOSVersion() >= 7 && (i._canUseBlob = !0,
...
!function(e) {
    ...
    !function(t) {
        ...
        function i(r) {
            console.log("pass_____1");
            if (!s) {
                s = !0,
                r || (r = {});
                var i = navigator.userAgent.toLowerCase();
                if (i.indexOf("egretnative") >= 0 && -1 == i.indexOf("egretwebview") && (e.Capabilities.runtimeType = e.RuntimeType.RUNTIME2),
                i.indexOf("egretnative") >= 0 && e.nativeRender)
                    ...
                    e.sys.CanvasRenderBuffer = t.CanvasRenderBuffer,
                    i.indexOf("egretnative") >= 0 && "webgl" != l && (e.$warn(1051),
                    l = "webgl"),
                    n(l);
                    var u = void 0;
                    if (r.canvasScaleFactor)
                        u = r.canvasScaleFactor;
...
!function(e) {
    ...
    !function(t) {
        ...
        function o(t, i, n, a) {
            ...
            "webgl" == e.Capabilities.renderMode) {
                var o = void 0;
                this.$renderBuffer ? o = this : (o = new e.RenderTexture,
                o.drawToTexture(new e.Bitmap(this)));
            ...
            e.prototype.cacheArrays = function(e, t, r, i, n, a, o, s, c, l, h, u, d, f, p) {
                ...
                if (d) {
                    ...
                    M = u.length; M > D; D += 2)
                        ...
                        C[$ + 1] = x * B + b * O + E,
                        p ? (C[$ + 2] = (t + (1 - I) * n) / l,
                        C[$ + 3] = (r + A * i) / h) : (C[$ + 2] = (t + A * i) / l,
                        C[$ + 3] = (r + I * n) / h),
                        C[$ + 4] = v;
                    if (this.hasMesh)
                        for (var P = 0, W = f.length; W > P; ++P)
                            this.indicesForMesh[this.indexIndex + P] = f[P] + this.vertexIndex;
    ...
    !function(t) {
        var r = function(r) {
            function n(i, n, a) {
                ...
                e.nativeRender)
                    return a ? o.surface = o.context.surface : o.surface = new egret_native.NativeRenderSurface(o,i,n,a),
            ...
            n.prototype.resize = function(t, r, i) {
                return t = t || 1,
                r = r || 1,
                e.nativeRender ? void this.surface.resize(t, r) : (this.context.pushBuffer(this),
        ...
        var r = ["source-over", "lighter", "destination-out"]
          ...
          , a = function() {
            ...
            a.prototype.drawWithFilter = function(t, a, o, s) {
                ...
                if (x.context.pushBuffer(x),
                c += t.$mask ? this.drawWithClip(t, x, -f, -p) : t.$scrollRect || t.$maskRect ? this.drawWithScrollRect(t, x, -f, -p) : this.drawDisplayObject(t, x, -f, -p),
                x.context.popBuffer(),
                c > 0) {
            ...
            a.prototype.drawWithClip = function(t, a, o, s) {
                ...
                if (d || t.$children && 0 != t.$children.length) {
                    ...
                    if (m.context.setGlobalCompositeOperation(i),
                    m.context.popBuffer(),
                    l > 0) {
                        l++,
                        ...
                        a.context.drawTexture(m.rootRenderTarget.texture, 0, 0, R, C, 0, 0, R, C, R, C),
                        u && m.context.popMask(),
